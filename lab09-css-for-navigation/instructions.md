...
- Make a copy of all the files from Lab 7 and put them in a new folder named **lab09**
...
*NOTE: from here on out, do not edit the **start.html** file anymore.  Although it won't be part of your Lab 9 website (it won't be in the navigation system), it can just ride-along with the other files.  We'll need the start file in a later lab.*
...
- Differentiate the anchor tags in the menu from the other anchor tags in this document:
  ...
  - Continue making more embellishments to various parts of the navigation elements; in ISTE-140 more is better, but whatever you do make sure the menu is still readable and usable
...
- When you are done with your web site, close everything and use an FTP tool to access your account on iste140.org and upload your files:
  - In a web browser (any), go to this address to check your handiwork:<br>`www.iste140.org/accountname/lab09`<br>(where “accountname” is your account name)
  - NOTE: there is *no* homepage for your website (yet) - just four HTML files plus your dead **start.html** file.  In Blackboard, you don't have to link to any of the HTML files.  Just provide a link to the **lab09**  folder - the TAs will figure it out from there.
...
- In our MyCourses section, in Lab 9, post a link to your webpage to receive credit for this Lab.
