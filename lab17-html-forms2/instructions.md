# Lab 17: HTML Forms, Part 2
*Due: Tuesday, November 30, 2021*

For this lab you will integrate the non-working HTML form from Lab 16 into your lab website and power it with a PHP script.

## Step 1: Copy Lab 15

- Make a copy of your Lab 15 files (*not Lab 16!*) and put them in a folder named **lab17**
...
- In your **lab17** folder, make a duplicate copy of any **one** of your existing webpages - any of them *except* your start.php file - name it: **contact.php**
...
- Get your Lab 15 file, **contact.html** and copy-out the FORM element (all of it, from the opening FORM tag to the closing FORM tag) and paste it into the new **contact.php** file, directly under the *nav.php* statement
...
- Edit the **inc/html-top.php** file:
  ...
  - Change the TITLE to say "Lab 17..." instead of Lab 11
...
- Copy all the text out of that file (117 lines) and paste it in the TOP of your **form-processor.php** file, *above* the PHP **inc/html-top.php** statement on Line 1
...
- FTP your **lab17** folder to the class webserver 
- In a web browser test the **contact.php** page:<br> **www.iste140.org/accountname/lab17/contact.php**<br>(where "*accountname*" is your account name)
...
- A few seconds later, you should receive an email with the contents of your labels and web form data
  - If not, check your **lab17** folder for the existence of a file named **error_log**; open it and read it.  It will point you to the location(s) in your form processor where there is a mistake.
- If it's all working as expected, go to our ISTE-140 section of myCourses, and in Assignments/Lab 17, post a link to the **contact.php** webpage to receive credit for this Lab.
