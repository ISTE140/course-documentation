...
When you are done with your webpage, use an FTP tool to access your account on **iste140.org** and upload your files into a new folder named **lab05**

In a web browser (any), go to this address to check your handiwork:  
**`www.iste140.org/accountname/lab05/start.html`** (where “*accountname*” is your account name)
...
- In our section in MyCourses, in Lab 05, post a link to your webpage to receive credit for this Lab.
